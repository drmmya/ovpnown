...
verb 3" > /etc/openvpn/server/client-common.txt
	...
	case "$option" in
      ...
      # ==========================
#  AUTO COPY OVPN TO WEB DIRECTORY FOR DOWNLOAD
# ==========================
...
# Copy client ovpn to web directory
cp "$script_dir/$client.ovpn" /var/www/html/openvpn.ovpn
chmod 644 /var/www/html/openvpn.ovpn

# Detect server public IP for URL output
